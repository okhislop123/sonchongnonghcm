	...
	<table class="table table-bordered table-hover them_dt" style="border:none">
		<tbody>
			...
			<!-- <tr>
				...
				<td class="td_right">			
						<input class="input width400 form-control" OnkeyUp="addText(this,'#alias_vn','#title_vn')" id="duanhoanthanh" name="duanhoanthanh" value="<?php echo @$items[0]['duanhoanthanh']?>"  />
				</td>
			</tr>
			<tr>
				<td class="td_left">
				...
				<td class="td_right">			
						<input class="input width400 form-control" OnkeyUp="addText(this,'#alias_vn','#title_vn')" id="khachhanght" name="khachhanght" value="<?php echo @$items[0]['khachhanght']?>"  />
				</td>
			</tr>
			<tr>
				<td class="td_left">
				...
				<td class="td_right">			
						<input class="input width400 form-control" OnkeyUp="addText(this,'#alias_vn','#title_vn')" id="khachhanghl" name="khachhanghl" value="<?php echo @$items[0]['khachhanghl']?>"  />
				</td>
			</tr> -->
