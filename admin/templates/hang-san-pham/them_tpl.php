...
<ol class="breadcrumb">
  ...
  <li class="active"><a href="#"><?php if(isset($_GET['id'])) echo "Sửa hãng sản phẩm"; else echo "Thêm hãng sản phẩm" ?></a></li>
</ol>
<div class="col-xs-12">
...
<script type="text/javascript" charset="utf-8" async defer>
	...
	function kiem_tra_link_vn(id){
		...
		if(alias == ''){
			alert("Chưa nhập liên kết (vn).");
		}else{
			$.ajax({
				url: "./sources/kiem_tra_alias.php",
				type:'POST',
				data:"bang=#_hangsanpham&alias_vn="+alias+"&id="+id,
	...
	function kiem_tra_link_us(id){
		...
		if(alias == ''){
			...
			$.ajax({
				url: "./sources/kiem_tra_alias.php",
				type:'POST',
				data:"bang=#_hangsanpham&alias_us="+alias+"&id="+id,
				success: function(data){
					$("#alias_us").val(data);
					dk2 = 1;
				}
