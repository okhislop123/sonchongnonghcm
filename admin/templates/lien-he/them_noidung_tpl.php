...
<ol class="breadcrumb">
  ...
  <li class="active"><a href="#">Nội dung hiển thị liên hệ</a></li>
</ol>
<div class="col-xs-12">
<form name="frm" method="post" action="index.php?p=lien-he&a=save_noidung&id=<?=@$_REQUEST['id']?>&page=<?=@$_REQUEST['page']?>" enctype="multipart/form-data">
		...
		<table class="table table-bordered table-hover them_dt" style="border:none">
			<tbody>
				...
				<tr>
					...
					<td class="td_right">
						<input type="button" value="Thoát" onclick="javascript:window.location='index.php?p=lien-he&a=man'" class="btn btn-primary" />
					</td>
				</tr>
			</tbody>
		</table>
