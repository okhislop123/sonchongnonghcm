...
<div class="col-xs-12">
<form name="frm" method="post" action="index.php?p=mausac&a=save&id=<?=@$_REQUEST['id']?>&page=<?=@$_REQUEST['page']?>" enctype="multipart/form-data">
		...
		<table class="table table-bordered table-hover them_dt" style="border:none">
			<tbody>
				...
				<tr>
					...
					<td class="td_right">
						<input type="button" value="Thoát" onclick="javascript:window.location='index.php?p=mausac&a=man'" class="btn btn-primary" />
					</td>
				</tr>
			</tbody>
		</table>
