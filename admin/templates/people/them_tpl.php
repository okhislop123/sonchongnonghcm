...
<ol class="breadcrumb">
	...
	<li class="active"><a href="<?= urladmin ?>index.php?p=people&a=man">People</a></li>
	<li class="active"><a href="#"><?php if (isset($_GET['id'])) echo "Sửa ";
									else echo "Thêm mới" ?></a></li>
</ol>
<div class="col-xs-12">
	<form name="frm" method="post" action="index.php?p=people&a=save&id=<?= @$_REQUEST['id'] ?>&page=<?= @$_REQUEST['page'] ?>&loaitin=<?= @$_GET['loaitin'] ?>" enctype="multipart/form-data">
		...
		<div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
			<ul id="myTabs" class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active">
					<a href="#id_viet" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Ngôn ngữ </a>
				</li>
						...
						<table class="table table-bordered table-hover them_dt" style="border:none">
							<tbody>
								...
								<tr>
									...
									<td class="td_right">
										<input type="text" class="input width400 form-control" id="ten_vn" name="ten_vn" value="<?php echo @$items[0]['ten_vn'] ?>" />
									</td>
								</tr>
								<tr>
									<td class="td_left">
									...
									<td class="td_right">
										<input type="color" class="input width400 form-control" id="mamau" name="mamau" value="<?php echo @$items[0]['mamau'] ?>" />
									</td>
								</tr>
								<!-- <tr>
					<td class="td_left">
					...
					<table class="table table-bordered table-hover them_dt" style="border:none">
						<tbody>
							...
							<tr>
								...
								<td class="td_right">
									<!-- <input type="checkbox" class="chkbox" name="noi_bat" <?php if (isset($items[0]['noi_bat'])) {
																									if (@$items[0]['noi_bat'] == 1) echo 'checked="checked"';
																									else echo '';
																								} ?> id="noi_bat"><label class="lb_nut" for="noi_bat">Tiêu biểu</label>  -->
							...
							<tr>
								...
								<td class="td_right">
									...
									<div class="luu thoat">
										<input type="button" value="Thoát" onclick="javascript:window.location='index.php?p=people&a=man'" class="btn btn-primary" />
									</div>
								</td>
							</tr>
						</tbody>
