<?php 
	...
	if($_SESSION['quyen'] == 2) $d->location("index.php?p=ql-user1&a=man");
...
<ol class="breadcrumb">
  ...
  <li class="active"><a href="index.php?p=ql-user1&a=man">Quản lý user</a></li>
  <li class="active"><a href="#">User</a></li>
</ol>
<div class="col-xs-12">
<form name="frm" method="post" action="index.php?p=ql-user1&a=save&id=<?=@$_REQUEST['id']?>&page=<?=@$_REQUEST['page']?>" enctype="multipart/form-data">
	...
	<tbody>
		...
		<tr>
			...
			<td class="td_right" style="">
				...
				<input type="button" value="Thoát" onclick="javascript:window.location='index.php?p=ql-user1&a=man'" class="btn btn-primary" />
			</td>
		</tr>
	</tbody>
</table>
