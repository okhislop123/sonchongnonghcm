...
<div class="col-xs-12">
<form name="frm" method="post" action="index.php?p=size&a=save&id=<?=@$_REQUEST['id']?>&page=<?=@$_REQUEST['page']?>&loaitin=<?=@$_GET['loaitin']?>" enctype="multipart/form-data">
			...
			<table class="table table-bordered table-hover them_dt" style="border:none">
				...
				<tr>
					...
					<td class="td_right">
						...
						<div class="luu thoat">
							<input type="button" value="Thoát" onclick="javascript:window.location='index.php?p=size&a=man'" class="btn btn-primary" />
						</div>
					</td>
				</tr>
				</tbody>
