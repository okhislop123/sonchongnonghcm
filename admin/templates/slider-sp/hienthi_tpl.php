...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="index.php?p=slider-sp&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>" class="text-danger" title="Sửa"><?=$items[$i]['title_vn']?></a><br/>
				<a href="index.php?p=slider-sp&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>" class="text-danger" title="Sửa"><?=$items[$i]['title_us']?>
			</td>
			<td>
				<a href="index.php?p=slider-sp&a=edit&id=<?=$items[$i]['id']?>&page=<?=@$_GET['page']?>"><img src="../img_data/images/<?=$items[$i]['hinh_anh']?>" alt="" style="max-width:50px; max-height:50px"></a>
			</td>
			<!-- 
			<td>
