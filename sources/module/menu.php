...
foreach ($nav as $item) {
    ...
    if (count($sub) > 0) {
        ...
        $menu .= '<li class="dropdown dropdown2">
                        <a class="' . $active . '" href="' . URLPATH . $item['alias_' . $lang] . '.html" title="' . $item['ten_' . $lang] . '">' . $item['ten_' . $lang] . ' <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            ' . $menusub . '
                        </ul>
                    </li>';
    } else {
        $menu .= '<li><a class="' . $active . '" href="' . URLPATH . $item['alias_' . $lang] . '.html" title="' . $item['ten_' . $lang] . '">' . $item['ten_' . $lang] . '</a></li>';
    }
}
echo $menu;
